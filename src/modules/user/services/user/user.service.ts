...
export class UserService {
   ...
   * @returns {Promise<User>} A Promise that resolves with the user object if found, otherwise resolves to null.
   *
  ...
  /**
   * findUserById - The function retrieves a user  based on their id.
   *
   * @param id The id of the user to be retrieved.
   * @returns {Promise<User>} A Promise that resolves with the user object if found, otherwise resolves to null.
   *
   * a. The method takes a 'id' parameter, which specifies the id of the user to be retrieved.
   * b. It queries  to find a user with the provided id.
   * c. If a user with the given id is found, the method returns a user with the id.
   * d. If a user with the id is not found the method will return an error message.
   */
   ...
   */
  async editUser(id: number, updateUserDto: CreateUserDto): Promise<User> {
